...
function UpdateSection() {
  ...
  const handleEvent = async (e) => {
    try {
      e.preventDefault();
      await updateDoc(updateRef, dataObj);
          ...
          <div class="w-full max-w-xs">
            ...
            <div class="w-full flex flex-col justify-center items-center md:mt-28 md:ml-96">
              ...
              <div class="flex flex-row">
                <form class="bg-white md:ml-40 md:mt-4 md:w-max  shadow-md rounded px-8 pt-6 pb-8 mb-4">
                  <h1 class="text-amber-950 text-2xl font-semibold">
                    Previous Blog Details
                  </h1>
                  <div class="mb-4">
                    <label
